  ...
  return (
   ...
   lg:grid-cols-[fr_600px] lg:grid-rows-1 lg:h-[550px] lg:pl-25
    grid-cols-1 grid-rows-[270px_355px] h-auto ">
      ...
      <article className="hero-article flex flex-col justify-center h-full lg:gap-7 lg:col-1 lg:row-1 lg:pr-30 lg:p-0
      row-2 col-1 gap-5 p-8">
        ...
        <div className="buttons-container flex gap-5 justify-center lg:justify-start lg:mt-0 mt-5">
          <button type="button" name="Chrome" className="hero-button bg-blue-600 tracking-wider rounded-md shadow-md font-medium text-grey-50 lg:text-[.8rem] text-[13px]
          lg:w-42 w-38
          ...
          lg:w-42 lg:p-3 p-3 w-38 text-[13px]
      ...
      <div className="image-hero-container relative flex justify-center lg:col-start-2 lg:row-1 lg:w-180 
      row-start-1 col-1 w-full h-auto">
